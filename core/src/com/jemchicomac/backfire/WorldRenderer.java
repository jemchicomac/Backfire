...
public class WorldRenderer implements InputProcessor {
	...
	public WorldRenderer() {
		...
		// Mouse cursor disappears with this
		...
		//camera.setToOrtho(false, 30* (w/h), 30);
	...
	public void render (float delta) {
		...
		if (isDebugRenderEnabled) logDebug();
		
		spriteBatch.end();
		
		if (isDebugRenderEnabled) drawDebug();
	...
	public void logDebug(){
		...
		debugFont.draw(spriteBatch, "Hello World", 20, 20);
	...
	public boolean keyDown(int keycode) {
		...
		// Use "D" to enable or disable Debug Mode
		
		if (keycode == Keys.D) isDebugRenderEnabled ^= true;
		
		// Use "ESC" to end the game (seems I would need to do some disposes, though!)
